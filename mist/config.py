from mist import my_api_key

# Package Constants

# Mist dashboard API key, set either at instantiation or as an environment variable
# Replace "my_api_key.MY_PRIVATE_API_KEY" with your API Key for example " API_KEY_ENVIRONMENT_VARIABLE = 'YOUR API KEY HERE' "
API_KEY_ENVIRONMENT_VARIABLE = my_api_key.MY_PRIVATE_API_KEY 
...
# Optional identifier for API usage tracking; can also be set as an environment variable MIST_PYTHON_SDK_CALLER
MIST_PYTHON_SDK_CALLER = ''