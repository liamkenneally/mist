...
class RestSession(object):
    def __init__(
        ...
        self._req_session.headers = {
            ...
            'User-Agent': f'python-mist/{self._version} ' + user_agent_extended(self._be_geo_id, self._caller),
        }
        ...
        if self._logger:
            self._logger.info(f'Mist dashboard API session initialized with these parameters: {self._parameters}')
